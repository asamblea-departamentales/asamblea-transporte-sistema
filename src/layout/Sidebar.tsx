...
function Avatar({ initial, size = "md" }: { initial: string; size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <div style={{
      ...
      fontWeight: 700, color: "#BFDBFE", fontFamily: "inherit", flexShrink: 0,
    }}>
      {initial}
    </div>
  );
...
function NavLinkItem({ item, onClick, variant, pathname }: {
  ...
  if (variant === "bottom") {
    return (
      <NavLink to={to} end onClick={onClick}
        style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 4, padding: "8px 4px 6px", textDecoration: "none", position: "relative", minWidth: 0 }}
          ...
          return (
            <>
              <span style={{
                ...
                <Icon />
                {badge && (
                  <span style={{ position: "absolute", top: 1, right: 1, width: 7, height: 7, borderRadius: "50%", background: "#3B82F6", border: "1.5px solid #070B16" }} />
                )}
              </span>
              <span style={{
              ...
              {active && (
                <span style={{
                  ...
                  width: 20, height: 2, borderRadius: "2px 2px 0 0",
    ...
    return (
      ...
      >
        {({ isActive }) => {
          ...
          return (
            <>
              <span style={{ width: 34, height: 34, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", background: active ? "rgba(59,130,246,0.15)" : "rgba(255,255,255,0.04)", color: active ? "#60A5FA" : "rgba(255,255,255,0.4)", border: active ? "1px solid rgba(59,130,246,0.25)" : "1px solid transparent", transition: "all 150ms" }}>
                <Icon />
              </span>
  ...
  return (
    <NavLink to={to} end
      style={{ textDecoration: "none", height: "100%", display: "flex", alignItems: "center", position: "relative" }}
      ...
      {({ isActive }) => {
        ...
        return (
          <span style={{
            ...
            color: active ? "#EFF6FF" : "rgba(255,255,255,0.45)",
            fontSize: 13.5, fontWeight: active ? 600 : 500,
            letterSpacing: "-0.01em", whiteSpace: "nowrap",
            borderBottom: active ? "2px solid #3B82F6" : "2px solid transparent",
            transition: "all 150ms",
          }}>
            <span style={{ color: active ? "#60A5FA" : "rgba(255,255,255,0.4)", display: "flex" }}><Icon /></span>
            {label}
  ...
  return (
    <>
      <style>{`
        ...
        /* Desktop nav */
        .nav-desktop { background: transparent; }
        .nav-desktop:hover > span { color: rgba(255,255,255,0.75) !important; border-bottom-color: rgba(59,130,246,0.3) !important; }
        .nav-desktop-active {}
      ...
      >
        ...
        <div style={{ maxWidth: 1440, margin: "0 auto", width: "100%", height: "100%", display: "flex", alignItems: "stretch", padding: "0 28px", gap: 0 }}>

          {/* ── Logo — sin redondeo, borde derecho sutil ── */}
          <button
          ...
          >
            ...
            <div style={{
              ...
              <img src={logo} alt="Logo" style={{ height: 28, width: "auto", objectFit: "contain", filter: "brightness(0) invert(1)", opacity: 0.9 }} />
            </div>
            <div style={{ textAlign: "left" }}>
              <div style={{ fontSize: 9, fontWeight: 700, color: "rgba(147,197,253,0.5)", textTransform: "uppercase", letterSpacing: "0.12em", lineHeight: 1 }}>Asamblea</div>
              <div style={{ fontSize: 14, fontWeight: 700, color: "white", letterSpacing: "-0.02em", lineHeight: 1, marginTop: 3 }}>Transporte</div>
            </div>
          </button>
          ...
          <nav style={{
            flex: 1,
            display: "flex", alignItems: "stretch", justifyContent: "center",  // ← centrado
            gap: 0,
          }}>
            {navItems.map(item => (
            ...
            <div ref={notiRef} style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  background: notiOpen ? "rgba(59,130,246,0.12)" : "rgba(255,255,255,0.04)",
                  border: notiOpen ? "1px solid rgba(59,130,246,0.3)" : "1px solid rgba(255,255,255,0.08)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: notiOpen ? "#60A5FA" : "rgba(255,255,255,0.4)",
      ...
      >
        ...
        {/* Logo móvil — sin redondeo */}
        <button onClick={() => navigate("/dashboard")} style={{ display: "flex", alignItems: "center", gap: 10, background: "none", border: "none", cursor: "pointer" }}>
          <img src={logo} alt="Logo" style={{ height: 24, width: "auto", objectFit: "contain", filter: "brightness(0) invert(1)", opacity: 0.9 }} />
        ...
        <div ref={notiRef} style={{ position: "relative", flexShrink: 0 }}>
          <button
            onClick={() => { setNotiOpen(!notiOpen); setUserMenuOpen(false); }}
            style={{ width: 38, height: 38, borderRadius: 9, background: notiOpen ? "rgba(59,130,246,0.12)" : "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "center", color: notiOpen ? "#60A5FA" : "rgba(255,255,255,0.5)", position: "relative", cursor: "pointer" }}
          >
            <Icons.Bell />
      ...
      {/* Panel notificaciones mobile */}
      {notiOpen && (
        <div style={{ position: "fixed", top: 68, right: 12, left: 12, zIndex: 150, animation: "slideDown 150ms ease" }}>
          <NotificacionesPanel onClose={() => setNotiOpen(false)} />
        </div>
      )}
      ...
      <aside style={{
        ...
        <div style={{ height: 60, display: "flex", alignItems: "center", gap: 10, padding: "0 18px", borderBottom: "1px solid rgba(255,255,255,0.06)", flexShrink: 0 }}>
          <img src={logo} alt="Logo" style={{ height: 22, width: "auto", filter: "brightness(0) invert(1)", opacity: 0.9 }} />
          <div>
      ...
      >
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 1, background: "linear-gradient(90deg, transparent 0%, rgba(59,130,246,0.3) 50%, transparent 100%)" }} />
