      ...
      map.on("click", async (e) => {
        ...
        try {
          ...
          if (!origenCoords) {
            ...
            const emptyIndex = destinos.findIndex(d => !d.address.trim());
            if (emptyIndex !== -1) {
              updateDestination(destinos[emptyIndex].id, address, lat, lng);
            } else {
              setDestinos(prev => [...prev, { id: uid(), address, lat, lng }]);
            }
          }
        } catch (error) {
