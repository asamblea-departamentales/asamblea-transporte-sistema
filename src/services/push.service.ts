 ...
 * Intenta en /api/me/push-public-key y como fallback /api/motoristas/me/push-public-key
 */
...
export async function subscribeUserToPush(): Promise<boolean> {
  ...
  try {
    ...
    // Registrar la suscripción en el backend (intentar endpoints para cualquier rol)
    try {
