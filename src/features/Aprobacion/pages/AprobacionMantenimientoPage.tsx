        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-slate-800">{typeof data.vehiculo === 'object' ? (data.vehiculo as { marca?: string; placa?: string })?.marca || 'Vehículo' : data.vehiculo || 'Vehículo desconocido'} <span className="text-slate-500 font-normal">({data.placa || (data.vehiculo as { marca?: string; placa?: string })?.placa || 'Sin placa'})</span></p>
