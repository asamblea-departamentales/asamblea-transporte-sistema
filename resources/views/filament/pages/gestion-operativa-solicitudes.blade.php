    ...
    <div class="grid grid-cols-2 gap-3 xl:grid-cols-4">
        ...
        <div class="kpi-card">
            ...
            <div class="mt-2 text-xs text-gray-400">
                @if($kpi_total > 0) {{ round(($kpi_a / $kpi_total) * 100) }}% del total @else — @endif
            </div>
        </div>
        <div class="kpi-card">
            ...
            <div class="mt-2 text-xs text-gray-400">
                @if($kpi_total > 0) {{ round(($kpi_b / $kpi_total) * 100) }}% del total @else — @endif
            </div>
        </div>
        <div class="kpi-card">
            ...
            <div class="mt-2 text-xs text-gray-400">
                @if($kpi_total > 0) {{ round(($kpi_c / $kpi_total) * 100) }}% del total @else — @endif
            </div>
        </div>
    </div>
                ...
                <div class="sol-card-body">
                    <div class="meta-grid">
                        <div>
                            ...
                            <div class="meta-value">{{ $row['solicitante'] }}</div>
                        </div>
                        <div>
                            <div class="meta-label">Unidad</div>
                            <div class="meta-value">{{ $row['unidad'] }}</div>
                        </div>
                        <div>
                ...
                <div class="sol-card-actions">
                    ...
                    @if($etapa === 'bandeja')
                        @if($row['estado'] === 'pendiente')
                            <button wire:click="tomarParaRevision('{{ $row['tipo'] }}', {{ $row['id'] }})"
                    ...
                    @if($etapa === 'revision')
                        ...
                        <x-filament::modal width="2xl">
                            ...
                            <form wire:submit.prevent="validar('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    ...
                                    <textarea x-ref="hallazgosVal{{ $uid }}" class="modal-textarea" rows="2" placeholder="Describe hallazgos encontrados durante la revisión..."></textarea>
                                </div>
                                <div>
                                    <div class="modal-label">Comentario de validación <span class="text-red-400">*</span></div>
                                    <textarea x-ref="comentarioVal{{ $uid }}" class="modal-textarea" rows="3" placeholder="Comentario final de revisión..." required></textarea>
                                </div>
                        ...
                        <x-filament::modal width="2xl">
                            ...
                            <form wire:submit.prevent="observarRevision('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    ...
                                    <textarea x-ref="hallazgosObs{{ $uid }}" class="modal-textarea" rows="2" placeholder="Describe hallazgos técnicos..."></textarea>
                                </div>
                                <div>
                                    <div class="modal-label">Comentario / devolución <span class="text-red-400">*</span></div>
                                    <textarea x-ref="comentarioObs{{ $uid }}" class="modal-textarea" rows="3" placeholder="Comentario de devolución..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
                        ...
                        <x-filament::modal width="2xl">
                            ...
                            <form wire:submit.prevent="derivar('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    <div class="modal-label">Hallazgos (opcional)</div>
                                    <textarea x-ref="hallazgosDer{{ $uid }}" class="modal-textarea" rows="2" placeholder="Hallazgos relevantes..."></textarea>
                                </div>
                                <div>
                                    <div class="modal-label">Comentario de derivación <span class="text-red-400">*</span></div>
                                    <textarea x-ref="comentarioDer{{ $uid }}" class="modal-textarea" rows="3" placeholder="Explica el motivo de la derivación..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
                    ...
                    @if($etapa === 'aprobaciones')
                        ...
                        <x-filament::modal width="xl">
                            ...
                            <form wire:submit.prevent="aprobar('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                comentario: $refs.aprobarComentario{{ $uid }}.value
                            })" class="space-y-4 pt-2">
                                <div>
                                    <div class="modal-label">Comentario de aprobación <span class="text-red-400">*</span></div>
                                    <textarea x-ref="aprobarComentario{{ $uid }}" class="modal-textarea" rows="4" placeholder="Deja un comentario de aprobación..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
                                    <button type="submit" class="btn-accion btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <x-filament::modal width="xl">
                            ...
                            <form wire:submit.prevent="rechazar('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    ...
                                    <textarea x-ref="rechazarComentario{{ $uid }}" class="modal-textarea" rows="4" placeholder="Explica el motivo del rechazo..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
                        ...
                        <x-filament::modal width="xl">
                            ...
                            <form wire:submit.prevent="condicionar('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    ...
                                    <textarea x-ref="condComentario{{ $uid }}" class="modal-textarea" rows="4" placeholder="Describe las condiciones requeridas para su aprobación..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
                        ...
                        <x-filament::modal width="xl">
                            ...
                            <form wire:submit.prevent="reabrir('{{ $row['tipo'] }}', {{ $row['id'] }}, {
                                ...
                                <div>
                                    ...
                                    <textarea x-ref="reabrirComentario{{ $uid }}" class="modal-textarea" rows="4" placeholder="Justifica la reapertura de esta solicitud..." required></textarea>
                                </div>
                                <div class="flex justify-end pt-2">
