<x-filament-panels::page>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6 mb-6">
        ...
        <div class="rounded-xl border border-orange-200 bg-orange-50 dark:bg-orange-900/20 p-4 shadow-sm text-center">
            <p class="text-xs text-orange-600 uppercase tracking-wide mb-1">Total Galones</p>
            <p class="text-2xl font-bold text-orange-600">{{ $kpi_galones }} <span class="text-sm font-normal">gal</span></p>
        </div>

        <div class="rounded-xl border border-green-200 bg-green-50 dark:bg-green-900/20 p-4 shadow-sm text-center">
            <p class="text-xs text-green-600 uppercase tracking-wide mb-1">Valor Total</p>
            <p class="text-2xl font-bold text-green-600">${{ $kpi_valor_total }}</p>
        </div>
