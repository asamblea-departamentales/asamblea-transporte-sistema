...
class SolicitudMantenimientoController extends BaseSolicitudController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(
                $solicitud->fresh()->load(['vehiculo.vehMarca', 'vehiculo.vehModelo', 'tipoMantenimiento', 'solicitante']),
                201
            );
        } catch (\Exception $e) {
    ...
    public function show(SolicitudMantenimiento $solicitud)
    {
        ...
        return response()->json(
            $solicitud->load(['vehiculo.vehMarca', 'vehiculo.vehModelo', 'tipoMantenimiento', 'solicitante', 'aprobador', 'historialEstados'])
        );
    }
