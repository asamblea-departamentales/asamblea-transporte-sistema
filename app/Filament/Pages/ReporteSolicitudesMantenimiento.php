...
class ReporteSolicitudesMantenimiento extends Page implements Forms\Contracts\HasForms, Tables\Contracts\HasTable
{
    ...
    private function buildQuery(): Builder
    {
        ...
        if ($this->veh_tipo_mantenimiento_id) $q->where('veh_tipo_mantenimiento_id', $this->veh_tipo_mantenimiento_id);
        if ($this->estado)        $q->where('estado', $this->estado);
        if ($this->prioridad)     $q->where('prioridad', $this->prioridad);
        if ($this->tipo_solicitud) $q->where('tipo_solicitud', $this->tipo_solicitud);
    ...
    private function refreshKpis(): void
    {
        ...
        if ($this->veh_tipo_mantenimiento_id) $base->where('veh_tipo_mantenimiento_id', $this->veh_tipo_mantenimiento_id);
