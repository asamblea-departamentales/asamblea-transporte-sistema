...
// -----------------------------------------------------------------------------
// RECURSO PRINCIPAL PARA CONTRATOS DE MANTENIMIENTO
// -----------------------------------------------------------------------------
// Este recurso administra los contratos de mantenimiento vehicular, llantas,
// seguros y transporte de personal de la institución.
...
use App\Filament\Resources\ContratoMantenimientoResource\Pages;
...
class ContratoMantenimientoResource extends Resource
{
    protected static ?string $model = ContratoMantenimiento::class;

    protected static ?string $navigationGroup = 'Catálogos Globales';

    protected static ?string $navigationLabel = 'Contratos de Mantenimiento';
            ...
            Forms\Components\Section::make('Identificación del Contrato')
                ...
                ->schema([
                    Forms\Components\TextInput::make('numero_contrato')
                        ...
                        ->placeholder('Ej: MTO-2026-001')
                        ->extraInputAttributes(['class' => 'font-mono text-cyan-700 font-bold']),
                    Forms\Components\TextInput::make('nombre')
                        ->label('Nombre / Descripción')
                        ->required()
                        ->maxLength(255)
                        ->placeholder('Ej: Contrato mantenimiento Q1 2026')
                        ->columnSpan(1),
    ...
    {
        return [
            'index' => Pages\ListContratoMantenimientos::route('/'),
            'create' => Pages\CreateContratoMantenimiento::route('/create'),
            'edit' => Pages\EditContratoMantenimiento::route('/{record}/edit'),
            'view' => Pages\ViewContratoMantenimiento::route('/{record}'),
        ];
    }
}
