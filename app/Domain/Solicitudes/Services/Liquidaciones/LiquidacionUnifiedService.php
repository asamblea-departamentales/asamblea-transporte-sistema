...
class LiquidacionUnifiedService
{
    public function getAll(
        ...
        if (!$tipo || $tipo === 'transporte') {
            ...
            if ($fechaDesde) $q->whereDate($dateFieldTransporte, '>=', $fechaDesde);
            if ($fechaHasta) $q->whereDate($dateFieldTransporte, '<=', $fechaHasta);
            if ($solicitanteId) $q->where('solicitante_id', $solicitanteId);
            if ($motoristaId) $q->where('motorista_id', $motoristaId);
        ...
        if (!$tipo || $tipo === 'combustible') {
            ...
            if ($fechaDesde) $q->whereDate($dateFieldCombustible, '>=', $fechaDesde);
            if ($fechaHasta) $q->whereDate($dateFieldCombustible, '<=', $fechaHasta);
            if ($solicitanteId) $q->where('solicitante_id', $solicitanteId);
            if ($motoristaId) $q->where('motorista_id', $motoristaId);
        ...
        if (!$tipo || $tipo === 'mantenimiento') {
            ...
            if ($fechaDesde) $q->whereDate($dateFieldMantenimiento, '>=', $fechaDesde);
            if ($fechaHasta) $q->whereDate($dateFieldMantenimiento, '<=', $fechaHasta);
            if ($solicitanteId) $q->where('solicitante_id', $solicitanteId);
    ...
    {
        if (! $r instanceof SolicitudTransporte) return false;
    ...
    {
        if (! $r instanceof SolicitudMantenimiento) return false;
