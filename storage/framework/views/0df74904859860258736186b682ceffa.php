...
class PWAInstaller {
    constructor() {
        ...
        this.banner = null;
        this.config = <?php echo json_encode($config, 15, 512) ?>;
    ...
    init() {
        ...
        const isDebugMode = <?php echo e(config('app.debug') ? 'true' : 'false'); ?>;
    ...
    async registerServiceWorker() {
        if ('serviceWorker' in navigator) {
            try {
                const registration = await navigator.serviceWorker.register('<?php echo e(route("filament-pwa.service-worker")); ?>', {
        ...
        banner.innerHTML = `
            <div class="pwa-install-content">
                <div class="pwa-install-text">
                    <div class="pwa-install-title"><?php echo e(__('filament-pwa::pwa.install_title')); ?></div>
                    <div class="pwa-install-description"><?php echo e(__('filament-pwa::pwa.install_description')); ?></div>
                </div>
                <div class="pwa-install-actions">
                    <button class="pwa-install-btn primary" id="pwa-install-btn">
                        ...
                        <?php echo e(__('filament-pwa::pwa.install_button')); ?>
                    ...
                    <button class="pwa-install-btn" id="pwa-dismiss-btn">
                        ...
                        <?php echo e(__('filament-pwa::pwa.dismiss_button')); ?>
    ...
    showIOSInstallInstructions() {
        ...
        modal.innerHTML = `
            <div style="background: white; border-radius: 1rem; padding: 2rem; max-width: 400px; text-align: center; direction: ${this.config.dir || 'ltr'};">
                <h3 style="margin: 0 0 1rem 0; color: ${this.config.theme_color};"><?php echo e(__('filament-pwa::pwa.ios_install_title')); ?></h3>
                <p style="margin: 0 0 1.5rem 0; color: #666; line-height: 1.5;">
                    <?php echo e(__('filament-pwa::pwa.ios_install_description')); ?>

                </p>
                <ol style="text-align: ${this.config.dir === 'rtl' ? 'right' : 'left'}; color: #666; line-height: 1.8; margin: 0 0 1.5rem 0;">
                    <li><?php echo e(__('filament-pwa::pwa.ios_step_1')); ?> <span style="font-size: 1.2em;">⬆️</span></li>
                    <li><?php echo e(__('filament-pwa::pwa.ios_step_2')); ?></li>
                    <li><?php echo e(__('filament-pwa::pwa.ios_step_3')); ?></li>
                </ol>
                <button onclick="this.parentElement.parentElement.remove()" 
                    ...
                    <?php echo e(__('filament-pwa::pwa.got_it')); ?>
    ...
    showUpdateAvailable() {
        ...
        notification.innerHTML = `
            <div style="margin-bottom: 0.5rem; font-weight: bold;"><?php echo e(__('filament-pwa::pwa.update_available')); ?></div>
            <div style="margin-bottom: 1rem; font-size: 0.875rem;"><?php echo e(__('filament-pwa::pwa.update_description')); ?></div>
            <div style="display: flex; gap: 0.5rem; ${isRTL ? 'flex-direction: row-reverse;' : ''}">
                <button onclick="window.location.reload()"
                    ...
                    <?php echo e(__('filament-pwa::pwa.update_now')); ?>
                ...
                <button onclick="this.parentElement.remove()"
                    ...
                    <?php echo e(__('filament-pwa::pwa.update_later')); ?>
...
offlineStyles.textContent = `
    .offline::before {
        content: "<?php echo e(__('filament-pwa::pwa.offline_indicator')); ?>";
        position: fixed;
        top: 0;
        left: 0;
        right: 0;
...
<?php /**PATH C:\Users\steve\transporte-asamblea01\vendor\alareqi\filament-pwa\resources\views\installation-script.blade.php ENDPATH**/ ?>