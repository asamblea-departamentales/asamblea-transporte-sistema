...
<div class="email-container">
    ...
    <img
        src="<?php echo e(asset('images/logo-blanco-fondo-transparente.png')); ?>"
        alt="Logo"
        width="56"
        height="56"
...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($map_url)): ?>
                            <img src="<?php echo e($map_url); ?>" alt="Mapa aproximado de la ruta">
                        <?php else: ?>
                            <p style="color:#888;">
...
<?php /**PATH C:\Users\steve\transporte-asamblea01\resources\views/emails/notificacion_event.blade.php ENDPATH**/ ?>