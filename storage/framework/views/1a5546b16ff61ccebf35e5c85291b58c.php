...
const CACHE_NAME = '<?php echo e($swConfig['cache_name']); ?>';
const OFFLINE_URL = '<?php echo e($swConfig['offline_url']); ?>';

// Assets to cache for offline functionality
const STATIC_CACHE_URLS = <?php echo json_encode($swConfig['cache_urls'], 15, 512) ?>;

// Dynamic cache patterns
const CACHE_PATTERNS = {
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $swConfig['cache_patterns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php echo e($name); ?>: new RegExp('<?php echo $pattern; ?>'),
...
function getOfflineHTML() {
  return `
    ...
    <head>
        ...
        <script>
            tailwind.config = {
                theme: {
                    extend: {
                        colors: {
                            primary: '<?php echo e(config('filament-pwa.theme_color', '#A77B56')); ?>'
                        }
                    }
                }
            }
        ...
        <style>
            .retry-btn {
                background: <?php echo e(config('filament-pwa.theme_color', '#A77B56')); ?>;
            }
            .retry-btn:hover {
                background: <?php echo e(config('filament-pwa.theme_color', '#A77B56')); ?>dd;
            }
        </style>
    </head>
...
<?php /**PATH C:\Users\steve\transporte-asamblea01\vendor\alareqi\filament-pwa\resources\views\service-worker.blade.php ENDPATH**/ ?>