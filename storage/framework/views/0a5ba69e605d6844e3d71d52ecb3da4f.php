...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('heading', null, []); ?> Alertas <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl font-bold text-red-700 dark:text-red-300 leading-none mt-0.5"><?php echo e($d['incidencias']); ?></p>
                </div>
            </div>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-document-minus'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl font-bold text-yellow-700 dark:text-yellow-300 leading-none mt-0.5"><?php echo e($d['sinComprobantes']); ?></p>
                </div>
            </div>
        </div>
